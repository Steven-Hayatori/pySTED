...
# 背景突触
shroom1 = dg.Synapse(5, mode="custom", seed=42)

n_molecs_in_domain1, min_dist1 = 250, 50
shroom1.add_nanodomains(20, min_dist_nm=min_dist1, n_molecs_in_domain=n_molecs_in_domain1, valid_thickness=2, seed=SEED)
